...
For the past few months, we've been hard at work preparing for the public beta of our application. We've taken the time to ensure that everything is cleaned up and finalized before we allow people to [sign up](https://web.instellar.app/auth/registrations/new) and use our platform.
