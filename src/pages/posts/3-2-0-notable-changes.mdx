...
This post will highlight some of the things coming up in 3.2.0 release.

## Scheduling

We're planning on upgrading our platform on the 11th of April 2023 between 6:30pm to 7:00pm GMT +7. You can check the maintenance schduling on our status page.
