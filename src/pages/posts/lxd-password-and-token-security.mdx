...
LXD has many ways of handling authentication. You can use passwords or you an use tokens, you can even use something called [Candid](https://github.com/canonical/candid) for handling authentication with advanced RBAC capabilities. In this post we will cover some best practices for setting up LXD and how to make sure your cluster is secure.
