    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
      <div className="grid grid-cols-1 gap-6">
        {templates.map((template) => {
          return (
            <div key={`template_${template.id}`} className="flex items-center space-x-3 rounded-lg border border-slate-700 bg-slate-800 px-6 py-5 shadow-sm hover:border-slate-600">
