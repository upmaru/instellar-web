...
You can use our [terraform-module-template](https://github.com/insterra/aws-compute) to create a repository. Click on the `Use this template` link on the repo.
